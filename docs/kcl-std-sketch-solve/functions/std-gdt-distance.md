...
| `from` | `Face | TaggedFace | Edge` | The face or edge to measure from. Must be used with `to`. The default position is the entity center. | No |
| `to` | `Face | TaggedFace | Edge` | The face or edge to measure to. Must be used with `from`. The default position is the entity center. | No |
...
![Rendered example of gdt::distance 0](/kcl-test-outputs/serial_test_example_fn_std-gdt-distance1.png)
