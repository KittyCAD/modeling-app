---
title: "gdt::parallelism"
subtitle: "Function in std::gdt"
excerpt: "GD&T parallelism annotation specifying how much faces or edges may deviate from parallel orientation relative to datum references."
layout: manual
---
...
|----------|------|-------------|----------|
| `tolerance` | `number(Length)` | The tolerance zone size for parallel orientation. | Yes |
...
![Rendered example of gdt::parallelism 0](/kcl-test-outputs/serial_test_example_fn_std-gdt-parallelism1.png)
