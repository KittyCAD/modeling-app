---
title: "view::CameraView"
subtitle: "Type in std::view"
excerpt: "A camera viewpoint, stored as intent: what the camera looks at and from which direction, not a snapshot of engine camera state."
layout: manual
---
