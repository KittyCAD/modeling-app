...
<model-viewer
  ...
  src="/kcl-test-outputs/models/serial_test_example_fn_std-solid-patternCircular3d0_output.glb"
  ar
...
<model-viewer
  class="kcl-example"
  alt="Example showing a rendered KCL program that uses the patternCircular3d function"
  src="/kcl-test-outputs/models/serial_test_example_fn_std-solid-patternCircular3d1_output.glb"
  ar
  environment-image="/moon_1k.hdr"
