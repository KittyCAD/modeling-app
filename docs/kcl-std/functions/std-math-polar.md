...
excerpt: "Convert polar (angle, distance) coordinates to cartesian (x/y grid) coordinates."
layout: manual
---
...
<model-viewer
  ...
  src="/kcl-test-outputs/models/serial_test_example_fn_std-math-polar0_output.glb"
  ar
