...
gdt::distance(
  ...
  from?: Face | TaggedFace | Edge | EdgeEndpoint,
  to?: Face | TaggedFace | Edge | EdgeEndpoint,
  edges?: [Edge; 1+],
  precision?: number(_),
