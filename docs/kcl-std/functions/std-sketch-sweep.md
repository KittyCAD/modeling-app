...
| `projectedAxis` | [`Point3d`](/docs/kcl-std/types/std-types-Point3d) or [`Axis3d`](/docs/kcl-std/types/std-types-Axis3d) or [`Edge`](/docs/kcl-std/types/std-types-Edge) or [`TaggedEdge`](/docs/kcl-std/types/std-types-TaggedEdge) or [`Segment`](/docs/kcl-std/types/std-types-Segment) | If the sketch is oriented to the profile, see `orientProfilePerpendicular`, the local Y-axis of the sketch will be aligned to this axis as much as possible. Defaults to Z-axis. | No |
