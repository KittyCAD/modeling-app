...
excerpt: "GD&T annotation specifying how straight the line elements of faces must be."
layout: manual
---
...
Straightness is a form tolerance applied to a planar face. Every line
element of the face must lie between two parallel lines separated by the
given `tolerance`.
...
| `tolerance` | [`number(Length)`](/docs/kcl-std/types/std-types-number) | The amount of deviation from a perfectly straight line element that is acceptable. | Yes |
