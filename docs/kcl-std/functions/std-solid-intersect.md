...
```kcl
intersect(
  @solids: [Solid | ImportedGeometry; 2+],
...
|----------|------|-------------|----------|
| `solids` | [[`Solid`](/docs/kcl-std/types/std-types-Solid) or [`ImportedGeometry`](/docs/kcl-std/types/std-types-ImportedGeometry); 2+] | The solids or imported geometries to intersect. | Yes |
