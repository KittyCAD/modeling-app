...
| `draftAngle` | [`number(Angle)`](/docs/kcl-std/types/std-types-number) | Positive draft angle means the sketch gets smaller while extruding. Negative draft angle means the sketch gets bigger while extruding. | No |
