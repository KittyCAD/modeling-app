...
The fixed flank approximation requires at least five teeth. Roller diameters
that would make adjacent teeth overlap are rejected.

### Arguments

| Name | Type | Description | Required |
|----------|------|-------------|----------|
| `nTeeth` | [`number(_)`](/docs/kcl-std/types/std-types-number) | Number of teeth. Must be a whole number of at least five. | Yes |
...
<model-viewer
  ...
  src="/kcl-test-outputs/models/serial_test_example_fn_std-sprocket-rollerChain0_output.glb"
  ar
