...
<model-viewer
  ...
  src="/kcl-test-outputs/models/serial_test_example_fn_std-hole-holeAt0_output.glb"
  ar
...
<model-viewer
  class="kcl-example"
  alt="Example showing a rendered KCL program that uses the hole::holeAt function"
  src="/kcl-test-outputs/models/serial_test_example_fn_std-hole-holeAt1_output.glb"
  ar
  environment-image="/moon_1k.hdr"
