...
startSketchOn(
  ...
  face?: TaggedFace | Segment | FaceId,
...
| `face` | [`TaggedFace`](/docs/kcl-std/types/std-types-TaggedFace) or [`Segment`](/docs/kcl-std/types/std-types-Segment) or [`FaceId`](/docs/kcl-std/types/std-types-FaceId) | Identify a face of a solid if a solid is specified as the input argument (`planeOrSolid`). Incompatible with `normalToFace`. | No |
