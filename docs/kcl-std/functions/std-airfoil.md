...
Thicknesses from 4 through 40 percent of the chord are supported.
...
airfoilRegion = region(point = [0.5m, 0mm], sketch = naca2414)
extrude(airfoilRegion, length = 50mm)
...
<model-viewer
  ...
  src="/kcl-test-outputs/models/serial_test_example_fn_std-airfoil0_output.glb"
  ar
