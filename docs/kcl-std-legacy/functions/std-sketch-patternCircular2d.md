...
| `center` | `Point2d` | The center about which to make the pattern. This is a 2D vector. If not given, defaults to `[0, 0]`. | No |
| `arcDegrees` | `number(Angle)` | The arc angle (in degrees) to place the repetitions. Must be greater than 0. | No |
