...
| `axis` | `Axis2d | Edge | Segment | any` | Axis of revolution. Can be an Axis2d, an Edge, a solved Segment, or an edge reference object. Edge reference objects use adjacent faces, e.g. `{ sideFaces = [faceTag1, faceTag2] }`. | Yes |
