...
- When adding KCL programs, don't add any new kclVersion 1.0 code using `startSketchOn()`. Use kclVersion 2.0 with sketch blocks instead. Unless it's specifically testing an old version, all new KCL code should use the latest stable version.
