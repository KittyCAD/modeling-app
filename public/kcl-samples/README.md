...
Public previews use GPU engine rendering and are published to the documentation
and Aquarium. Generate the preview before updating the simulation snapshots for
a new sample. CPU regression images stay in `rust/kcl-lib/tests/kcl_samples` and
are never copied to the public screenshots directory.
