...
`
    ...
    const changeSketchArgsRetVal = changeSketchArguments(
      ...
      {
        type: 'sourceRange',
        sourceRange: [sourceStart, sourceStart + lineToChange.length, 0],
      },
      {
