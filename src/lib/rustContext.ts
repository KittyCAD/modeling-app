...
export default class RustContext {
  ...
  async execute(
    ...
    console.log('[COMPARE] node : Node<Program>, are they the same?', deepCompare(window.previousNode, node))
    console.log('[COMPARE] settings : DeepPartial<Configuration>, are they the same?', deepCompare(window.previousSettings, settings))
    console.log('[COMPARE] path : string, are they the same?', deepCompare(window.previousPath, path))
