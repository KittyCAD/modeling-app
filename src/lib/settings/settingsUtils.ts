...
export function configurationToSettingsPayload(
  ...
  return {
    ...
    modeling: {
      ...
      highlightColor: configuration?.settings?.modeling?.highlight_color,
      selectionColor: configuration?.settings?.modeling?.selection_color,
  ...
  return {
    settings: {
      ...
      modeling: {
        ...
        highlight_color: configuration?.modeling?.highlightColor,
        selection_color: configuration?.modeling?.selectionColor,
