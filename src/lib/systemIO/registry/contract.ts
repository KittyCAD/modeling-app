...
export type SystemIOOpenedProjectRef = {
  name: string
  path: string
...
export interface SystemIOAppContextService {
...
export const systemIOContract = defineContract({
  ...
  systemIOAppContextService: defineService<SystemIOAppContextService>(
    'system-io.app-context'
  ),
})

export const { systemIOAppContextService, systemIOService } = systemIOContract
