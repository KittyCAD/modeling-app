...
export const TOOLBAR_COMMAND_IDS = {
  ...
  sketching: {
    exit: 'zds.toolbar.sketching.exit',
    cancelTool: 'zds.toolbar.sketching.cancelTool',
    line: 'zds.toolbar.sketching.line',
    threePointArc: 'zds.toolbar.sketching.threePointArc',
    tangentialArc: 'zds.toolbar.sketching.tangentialArc',
    circleCenter: 'zds.toolbar.sketching.circleCenter',
    circleThreePoints: 'zds.toolbar.sketching.circleThreePoints',
    cornerRectangle: 'zds.toolbar.sketching.cornerRectangle',
    centerRectangle: 'zds.toolbar.sketching.centerRectangle',
  },
  sketchSolve: {
    exit: 'zds.toolbar.sketchSolve.exit',
    cancel: 'zds.toolbar.sketchSolve.cancel',
    line: 'zds.toolbar.sketchSolve.line',
    point: 'zds.toolbar.sketchSolve.point',
    spline: 'zds.toolbar.sketchSolve.spline',
    circleCenter: 'zds.toolbar.sketchSolve.circleCenter',
    centerArc: 'zds.toolbar.sketchSolve.centerArc',
    threePointArc: 'zds.toolbar.sketchSolve.threePointArc',
    tangentialArc: 'zds.toolbar.sketchSolve.tangentialArc',
    trim: 'zds.toolbar.sketchSolve.trim',
    cornerRectangle: 'zds.toolbar.sketchSolve.cornerRectangle',
    centerRectangle: 'zds.toolbar.sketchSolve.centerRectangle',
    angledRectangle: 'zds.toolbar.sketchSolve.angledRectangle',
    coincident: 'zds.toolbar.sketchSolve.coincident',
    midpoint: 'zds.toolbar.sketchSolve.midpoint',
    tangent: 'zds.toolbar.sketchSolve.tangent',
    parallel: 'zds.toolbar.sketchSolve.parallel',
    perpendicular: 'zds.toolbar.sketchSolve.perpendicular',
    equal: 'zds.toolbar.sketchSolve.equal',
    symmetric: 'zds.toolbar.sketchSolve.symmetric',
    vertical: 'zds.toolbar.sketchSolve.vertical',
    horizontal: 'zds.toolbar.sketchSolve.horizontal',
    fixed: 'zds.toolbar.sketchSolve.fixed',
    dimension: 'zds.toolbar.sketchSolve.dimension',
    horizontalDistance: 'zds.toolbar.sketchSolve.horizontalDistance',
    verticalDistance: 'zds.toolbar.sketchSolve.verticalDistance',
    construction: 'zds.toolbar.sketchSolve.construction',
  },
} as const
