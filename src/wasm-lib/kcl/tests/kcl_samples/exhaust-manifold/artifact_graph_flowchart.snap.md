...
flowchart LR
  ...
  subgraph path9 [Path]
    9["Path<br>[1328, 1422, 0]"]
    10["Segment<br>[1328, 1422, 0]"]
    11[Solid2d]
  end
  subgraph path12 [Path]
    12["Path<br>[1435, 1545, 0]"]
    13["Segment<br>[1435, 1545, 0]"]
    14[Solid2d]
  end
  ...
  subgraph path29 [Path]
    29["Path<br>[1328, 1422, 0]"]
    30["Segment<br>[1328, 1422, 0]"]
    31[Solid2d]
  end
  subgraph path32 [Path]
    32["Path<br>[1435, 1545, 0]"]
    33["Segment<br>[1435, 1545, 0]"]
    34[Solid2d]
  end
  ...
  subgraph path49 [Path]
    49["Path<br>[1328, 1422, 0]"]
    50["Segment<br>[1328, 1422, 0]"]
    51[Solid2d]
  end
  subgraph path52 [Path]
    52["Path<br>[1435, 1545, 0]"]
    53["Segment<br>[1435, 1545, 0]"]
    54[Solid2d]
  end
  ...
  subgraph path69 [Path]
    69["Path<br>[1328, 1422, 0]"]
    70["Segment<br>[1328, 1422, 0]"]
    71[Solid2d]
  end
  subgraph path72 [Path]
    72["Path<br>[1435, 1545, 0]"]
    73["Segment<br>[1435, 1545, 0]"]
    74[Solid2d]
  end
  subgraph path82 [Path]
    82["Path<br>[1874, 1909, 0]"]
    83["Segment<br>[1915, 1937, 0]"]
    84["Segment<br>[1943, 1990, 0]"]
    85["Segment<br>[1996, 2042, 0]"]
    86["Segment<br>[2048, 2095, 0]"]
    87["Segment<br>[2101, 2123, 0]"]
    88["Segment<br>[2129, 2160, 0]"]
    89["Segment<br>[2166, 2187, 0]"]
    90["Segment<br>[2193, 2240, 0]"]
    91["Segment<br>[2246, 2293, 0]"]
    92["Segment<br>[2299, 2346, 0]"]
    93["Segment<br>[2352, 2383, 0]"]
    94["Segment<br>[2389, 2425, 0]"]
    95["Segment<br>[2431, 2463, 0]"]
    96["Segment<br>[2469, 2516, 0]"]
    97["Segment<br>[2522, 2568, 0]"]
    98["Segment<br>[2574, 2630, 0]"]
    99["Segment<br>[2636, 2643, 0]"]
    100[Solid2d]
  end
  subgraph path101 [Path]
    101["Path<br>[2715, 2814, 0]"]
    102["Segment<br>[2715, 2814, 0]"]
    103[Solid2d]
  end
  subgraph path104 [Path]
    104["Path<br>[2829, 2928, 0]"]
    105["Segment<br>[2829, 2928, 0]"]
    106[Solid2d]
  end
  subgraph path107 [Path]
    107["Path<br>[2943, 3042, 0]"]
    108["Segment<br>[2943, 3042, 0]"]
    109[Solid2d]
  end
  subgraph path110 [Path]
    110["Path<br>[3057, 3156, 0]"]
    111["Segment<br>[3057, 3156, 0]"]
    112[Solid2d]
  end
  subgraph path113 [Path]
    113["Path<br>[3210, 3353, 0]"]
    114["Segment<br>[3210, 3353, 0]"]
    115[Solid2d]
  end
  subgraph path116 [Path]
    116["Path<br>[3368, 3509, 0]"]
    117["Segment<br>[3368, 3509, 0]"]
    118[Solid2d]
  end
  subgraph path119 [Path]
    119["Path<br>[3524, 3675, 0]"]
    120["Segment<br>[3524, 3675, 0]"]
    121[Solid2d]
  end
  subgraph path122 [Path]
    122["Path<br>[3690, 3840, 0]"]
    123["Segment<br>[3690, 3840, 0]"]
    124[Solid2d]
  end
  1["Plane<br>[783, 808, 0]"]
  8["Plane<br>[1301, 1320, 0]"]
  15["Sweep Sweep<br>[1557, 1580, 0]"]
  16[Wall]
  17["Cap Start"]
  18["Cap End"]
  ...
  75["Sweep Sweep<br>[1557, 1580, 0]"]
  76[Wall]
  77["Cap Start"]
  78["Cap End"]
  79["SweepEdge Opposite"]
  80["SweepEdge Adjacent"]
  81["Plane<br>[1849, 1868, 0]"]
  125["Sweep Extrusion<br>[3896, 3925, 0]"]
  126[Wall]
  127[Wall]
  128[Wall]
  129[Wall]
