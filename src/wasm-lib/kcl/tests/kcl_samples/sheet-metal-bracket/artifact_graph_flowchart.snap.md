...
flowchart LR
  ...
  subgraph path62 [Path]
    62["Path<br>[2289, 2355, 0]"]
    63["Segment<br>[2289, 2355, 0]"]
    64[Solid2d]
  end
  subgraph path65 [Path]
    65["Path<br>[2370, 2436, 0]"]
    66["Segment<br>[2370, 2436, 0]"]
    67[Solid2d]
  end
  subgraph path84 [Path]
    84["Path<br>[2645, 2671, 0]"]
    85["Segment<br>[2677, 2702, 0]"]
    86["Segment<br>[2708, 2749, 0]"]
    87["Segment<br>[2755, 2793, 0]"]
    88["Segment<br>[2799, 2806, 0]"]
    89[Solid2d]
  end
  subgraph path90 [Path]
    90["Path<br>[2817, 2884, 0]"]
    91["Segment<br>[2817, 2884, 0]"]
    92[Solid2d]
  end
  subgraph path93 [Path]
    93["Path<br>[2899, 2966, 0]"]
    94["Segment<br>[2899, 2966, 0]"]
    95[Solid2d]
  end
  ...
  68["Sweep Extrusion<br>[2446, 2473, 0]"]
  69[Wall]
  70[Wall]
  71[Wall]
  72[Wall]
  ...
  83["Plane<br>[2620, 2639, 0]"]
  96["Sweep Extrusion<br>[2976, 3003, 0]"]
  97[Wall]
  98[Wall]
  99[Wall]
  100[Wall]
  ...
  119["EdgeCut Fillet<br>[2479, 2608, 0]"]
  120["EdgeCut Fillet<br>[2479, 2608, 0]"]
  121["EdgeCut Fillet<br>[3009, 3139, 0]"]
  122["EdgeCut Fillet<br>[3009, 3139, 0]"]
  1 --- 2
  2 --- 3
  2 --- 4
  2 --- 5
