...
export const VITE_KC_API_BASE_URL = env.VITE_KC_API_BASE_URL as string | undefined
export const VITE_KC_SITE_BASE_URL = env.VITE_KC_SITE_BASE_URL as string | undefined
