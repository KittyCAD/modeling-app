...
export const fileCommandMeta: CommandBarMeta = {
  'Create file': {
    displayValue: (args: string[]) => `Create file "${args[0]}"`,
    args: [
      {
        name: 'name',
        type: 'string',
  ...
  'Open file': {
    displayValue: (args: string[]) => `Open file "${args[0]}"`,
    args: [
      {
        name: 'name',
        type: 'select',
  ...
  'Delete file': {
    displayValue: (args: string[]) => `Delete file "${args[0]}"`,
    args: [
      {
        name: 'name',
        type: 'select',
...
export const fileMachine = createMachine(
  {
    ...
    schema: {
      events: {} as
        ...
        | { type: 'Create file'; data: { name: string } }
        | { type: 'Delete file'; data: { file: FileEntry } }
