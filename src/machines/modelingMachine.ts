...
export const modelingMachine = createMachine(
  {
    ...
    states: {
      ...
      Sketch: {
        ...
        exit: ['sketch exit execute', 'tear down client sketch'],
      },
