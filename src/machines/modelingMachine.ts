      ...
      states: {
        ...
        'Arc three point tool': {
          states: {
            ...
            'Awaiting for circle center': {
              on: {
                'Add rectangle origin': 'Adding draft arc three point',
              },
