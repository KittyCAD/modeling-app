...
export const modelingMachine = setup({
  ...
  actors: {
    ...
    'animate-to-sketch-solve': fromPromise(async (_: { input: ArtifactId }) => {
      return {} as any // TODO
    }),
  ...
  states: {
    ...
    'animating to sketch solve mode': {
      invoke: {
        ...
        onDone: 'sketchMode',
        onError: 'Sketch no face',
        input: ({ event }): ArtifactId => {
          if (event.type !== 'Select sketch solve plane') return ''
          return event.data
        },
      },
    },
