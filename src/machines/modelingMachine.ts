  ...
  states: {
    idle: {
      on: {
        ...
        'Enter existing sketch solve': {
          target: 'animating to existing sketch solve',
          actions: [() => sceneInfra.animate()],
        },
      },
    ...
    'animating to existing sketch solve': {
      invoke: {
        ...
        input: ({ event }) => {
          ...
          if (event.type !== 'Enter existing sketch solve') {
            return
          }
          return event.data
        },
