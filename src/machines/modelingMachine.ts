  ...
  actions: {
    ...
    'add draft line': ({ event, context }) => {
      ...
      sceneInfra.setCallbacks({
        ...
        // onMouseLeave: () => {
        //   console.log('you left the scene')
        //   const draftPoint = sceneInfra.scene.getObjectByName(DRAFT_POINT)
        //   if (draftPoint) {
        //     sceneInfra.scene.remove(draftPoint)
        //   }
