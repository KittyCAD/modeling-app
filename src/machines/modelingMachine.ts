...
export const modelingMachine = setup({
  ...
  actions: {
    ...
    'enter sketching mode': () => {
      ...
      assign({ currentMode: 'sketching' })
    },
    'enter modeling mode': assign({ currentMode: 'modeling' }),
    'enter sketchSolve mode': assign({ currentMode: 'sketchSolve' }),
      ...
      states: {
        ...
        exiting: {
          invoke: {
            ...
            onDone: {
              target: '#Modeling.idle',
              actions: ['reset sketch metadata', 'enter modeling mode'],
            },
            onError: {
              target: '#Modeling.idle',
              actions: ['reset sketch metadata'],
