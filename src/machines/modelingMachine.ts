  ...
  actions: {
    ...
    'add axis n grid': ({
      ...
      const theCodeManager = providedCodeManager
        ...
        : codeManager
      // eslint-disable-next-line @typescript-eslint/no-floating-promises
      theCodeManager.updateEditorWithAstAndWriteToFile(theKclManager.ast, undefined, wasmInstance)
    },
    ...
    'Delete segment': ({
      ...
      const theSceneEntitiesManager = providedSceneEntitiesManager ? providedSceneEntitiesManager : sceneEntitiesManager
      const theSceneInfra = providedSceneInfra ? providedSceneInfra : sceneInfra
      // eslint-disable-next-line @typescript-eslint/no-floating-promises
    ...
    'do-constrain-remove-constraint': fromPromise(
      async ({
        ...
        await theCodeManager.updateEditorWithAstAndWriteToFile(
          updatedAst.newAst, undefined, wasmInstance
        )
    ...
    'Apply named value constraint': fromPromise(
      async ({
        ...
        const theCodeManager = input.codeManager
          ...
          : codeManager
        await theCodeManager.updateEditorWithAstAndWriteToFile(
          updatedAst.newAst, undefined, input.wasmInstance
        )
