      ...
      <div className="mx-4 mt-4 mb-2">
        ...
        <div className="space-y-2">
          ...
          <CoordinateInput
            ...
            testId="vector2d-y-input"
          />
        </div>
      </div>
      <p className="mx-4 mb-4 text-sm text-chalkboard-70 dark:text-chalkboard-40">
        Currently, you need to enter all XY values manually. Support for
        dragging references directly in the 3D scene is in development.
      </p>
    </form>
  )
}

export default CommandBarVector2DInput
