...
export const BillingDialog = () => {
  ...
  >
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="text-chalkboard-50">for unlimited usage of Text-to-CAD and more!</div>
      <BillingRemaining mode={BillingRemainingMode.ProgressBarStretch} />
      <div className="rounded-lg text-center p-1 cursor-pointer" style={{ backgroundColor: "black", color: "white" }}>Upgrade</div>
    </div>
  </div>
}
