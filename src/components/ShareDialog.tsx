...
export function ShareDialog({
  ...
  return (
    ...
    >
      <Popover.Panel
        focus={true}
        className="absolute right-0 top-full z-20 mt-2 flex w-[26rem] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-chalkboard-30/80 bg-chalkboard-10/95 text-sm text-chalkboard-100 shadow-2xl backdrop-blur-sm dark:border-chalkboard-80/60 dark:bg-chalkboard-90/95 dark:text-chalkboard-10"
      >
