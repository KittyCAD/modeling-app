...
function ModelingPaneButton({
  ...
  return (
    ...
    >
      <button
        className={`group pointer-events-auto flex items-center justify-center border-0 rounded-none border-transparent dark:border-transparent p-[8px] ${tooltipPosition === 'right' ? 'pr-[6px]' : 'pl-[6px]'} m-0 !outline-0 ${paneIsOpen ? ' !border-primary' : ''} ${paneConfig.cssClassOverrides?.button ?? ''}`}
