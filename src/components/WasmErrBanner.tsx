    ...
    >
      <Dialog.Panel className="max-w-3xl mx-auto">
        ...
        <a
          ...
          </a> is core part of how our app works. It might because you OS is not up-to-date.
          If you're able to update your OS to a later version try and see if that fixes the issue. If not create an issue on <a
