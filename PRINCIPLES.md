...
5. Know the life cycle of the data you are working with 
    ...
    - Does it get stale?
    - Does it need to exist across the entire application?
    - Does it need to live within the mount/unmount of a React component?
    - Does it need to live in React?
    - Does it need to live in Javascript memory?
    - When it is available?
    - Does code depend on it? 
    - Where it is populated from?
      - User input
      - HTTP request
      - Websocket request
      - WASM instance
