...
extrude001 = extrude(region001, length = 100)`
    ...
    await test.step(`Confirm code is added to the editor, scene has changed`, async () => {
      ...
      await editor.expectEditor.toContain(
        `
        helix001 = helix(
          axis = getOppositeEdge(region001.tags.line3),
          revolutions = 20,
          angleStart = 0,
          radius = 1,
          ccw = true,
...
extrude001 = extrude(region001, length = -12)`
    const firstFilletDeclaration = `fillet001 = fillet(extrude001, tags=region001.tags.line2, radius=5)`
    const secondFilletDeclaration = `fillet002 = fillet(extrude001, tags=getOppositeEdge(region001.tags.line2), radius=5)`
...
region001 = region(segments = [sketch001.line1, sketch001.line2])
extrude001 = extrude(region001, length = -12)`
    const firstChamferDeclaration = `chamfer001 = chamfer(extrude001, tags=region001.tags.line2, length=5)`
    const secondChamferDeclaration = `chamfer002 = chamfer(extrude001, tags=getOppositeEdge(region001.tags.line2), length=5)`
...
region002 = region(point = [-20.0275mm, 10mm], sketch = sketch002)`
    ...
    const newCodeToFind = `revolve001 = revolve(region002, angle = 360deg, axis = getOppositeEdge(region001.tags.line1))`
