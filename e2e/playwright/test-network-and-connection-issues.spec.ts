...
test.describe('Test network related behaviors', { tag: '@desktop' }, () => {
  test('simulate network down and network little widget', {
    tag: '@skipLocalEngine',
  ...
  test('Engine disconnect & reconnect in sketch mode', {
    tag: '@skipLocalEngine',
  }, async ({
    page,
    context,
  ...
  test('Paused stream freezes view frame, unpause reconnect is seamless to user', {
    tag: '@skipLocalEngine',
