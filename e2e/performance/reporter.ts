      ...
      try {
        await appendFile(
          ...
          [
            ...
            'Provisional regression rule: median paired increase at least 24 ms, at least 9/10 positive pairs, and positive medians in both execution-order groups. All outcome and Event Timing strata are required for a passing comparison. A/A and real-delay calibration remain required.',
            `Unavailable presentation strata: **${report.unavailablePresentationStrata}**. Missing entries remain unknown, not zero or evidence of slowness. Incomplete coverage is inconclusive and fails the check unless another stratum already demonstrates a regression.`,
