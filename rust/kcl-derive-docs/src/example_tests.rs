...
pub const TEST_NAMES: &[&str] = &[
    ...
    "std-gdt-flatness-2",
    "std-gdt-flatness-3",
    "std-gdt-straightness-0",
    "std-gdt-straightness-1",
    "std-gdt-straightness-2",
    "std-gdt-circularity-0",
    "std-gdt-circularity-1",
    "std-gdt-circularity-2",
    "std-gdt-cylindricity-0",
    "std-gdt-cylindricity-1",
    "std-gdt-cylindricity-2",
    "std-gdt-concentricity-0",
    "std-gdt-concentricity-1",
    "std-gdt-symmetry-0",
    "std-gdt-symmetry-1",
    "std-gdt-runout-0",
    "std-gdt-angularity-0",
    "std-gdt-angularity-1",
    ...
    "std-gdt-parallelism-1",
    "std-gdt-position-0",
    "std-gdt-position-1",
    "std-gdt-profile-0",
    "std-gdt-profile-1",
    "std-gdt-profileLine-0",
    "std-gdt-profileLine-1",
    "std-gdt-profileSurface-0",
    "std-helix-0",
    "std-helix-1",
    "std-helix-2",
    "std-helix-3",
    ...
    "std-sketch-revolve-14",
    "std-sketch-revolve-15",
    "std-sketch-revolve-16",
    ...
    "std-sketch-extrude-9",
    "std-sketch-extrude-10",
    "std-sketch-extrude-11",
    "std-sketch-extrude-12",
    "std-sketch-extrude-13",
    "std-sketch-extrude-14",
    "std-sketch-extrude-15",
    "std-sketch-extrude-16",
    "std-sketch-extrude-17",
    ...
    "std-solver-angle-0",
    "std-solver-angleDimension-0",
    "std-solver-symmetric-0",
    "std-solver-tangent-0",
    ...
    "std-sketch-region-1",
    "std-sketch-region-2",
    "std-sketch-planarSurface-0",
    "std-sketch-planarSurface-1",
    "std-sketch-planarSurface-2",
    ...
    "std-transform-mirror3d-0",
    "std-transform-mirror3d-1",
    "std-transform-mirror3d-2",
    "std-transform-mirror3d-3",
    ...
    "std-hole-countersink-1",
    "std-hole-countersink-2",
    "std-hole-countersink-3",
