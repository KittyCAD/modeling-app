...
#[wasm_bindgen]
pub fn change_kcl_settings(code: &str, len_str: &str, exp_str: &str) -> Result<String, String> {
    console_error_panic_hook::set_once();
    ...
    // TODO: should pass as WarningLevel instead
    let new_program = program.change_kcl_settings(len, Some(exp_str.to_string())).map_err(|e| e.to_string())?;
