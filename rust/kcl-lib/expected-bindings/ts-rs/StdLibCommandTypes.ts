...
export type StdLibCommandArgShape = { name: string, ty: string | null, docs: string | null, required: boolean, special: boolean, experimental: boolean, deprecated: boolean, deprecatedSince: string | null, removedSince: string | null, };
