...
mod impeller_region_repro {
    const TEST_NAME: &str = "impeller_region_repro";
    ...
    #[tokio::test(flavor = "multi_thread")]
    async fn kcl_test_execute() {
        tokio::time::timeout(std::time::Duration::from_secs(60), super::execute(TEST_NAME, false))
            .await
            .expect("impeller region repro did not finish within 60 seconds");
    }
}
mod tag_inner_face {
