...
"#;
        ...
        let ctx = crate::test_server::new_context(true, None, program.language_version().unwrap())
            .await
            .unwrap();
...
"#;
        ...
        let program = crate::Program::parse_no_errs(code).unwrap();
        let ctx = crate::test_server::new_context(true, Some(main_path), program.language_version().unwrap())
            .await
            .unwrap();
