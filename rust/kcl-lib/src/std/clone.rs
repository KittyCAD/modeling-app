...
mod tests {
    ...
    use crate::exec::KclValuePresentation;
...
"#;
        ...
        let KclValuePresentation::Sketch { value: cube } = cube else {
            panic!("Expected a sketch, got: {cube:?}");
        };
        let KclValuePresentation::Sketch { value: cloned_cube } = cloned_cube else {
...
"#;
        ...
        let KclValuePresentation::Solid { value: cube } = cube else {
            panic!("Expected a solid, got: {cube:?}");
        };
        let KclValuePresentation::Solid { value: cloned_cube } = cloned_cube else {
