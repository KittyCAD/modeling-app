...
pub mod front {
    ...
    pub use crate::frontend::{
        ...
        trim::{
            AttachToEndpoint, CoincidentData, ConstraintToMigrate, Coords2d, EndpointChanged, NextTrimResult,
            TrimOperation, TrimTermination, TrimTerminations, arc_arc_intersection, execute_trim_loop,
            get_next_trim_coords, get_position_coords_for_line, get_position_coords_from_arc,
