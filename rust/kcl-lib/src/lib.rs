...
pub mod front {
    pub use crate::frontend::{
        ...
        sketch::{
            ...
            PointCtor, Segment, SegmentCtor, Sketch, SketchApi, SketchApiStub, SketchArgs, SketchExecOutcome,
            StartOrEnd, TangentArcCtor, ThreePointArcCtor, ThreePointCircleCtor,
        },
    };
}
