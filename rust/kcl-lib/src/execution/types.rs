...
impl RuntimeType {
    ...
    pub fn subst_units(&mut self, substs: UnitSubsts) {
        match self {
            ...
            RuntimeType::Object(records) => records.iter_mut().for_each(|(_, t)| t.subst_units(substs)),
        }
    }
}
...
"#;
    ...
    async fn coerce_substs() {
        ...
        let ty1 = RuntimeType::Object(vec![
            ("foo".to_owned(), RuntimeType::bool()),
            (
                "bar".to_owned(),
                RuntimeType::Primitive(PrimitiveType::Number(NumericType::mm())),
        ...
        let ty3 = RuntimeType::Object(vec![
        ...
        let ty4 = RuntimeType::Object(vec![
            ("foo".to_owned(), RuntimeType::angle()),
            (
                "bar".to_owned(),
                RuntimeType::Primitive(PrimitiveType::Number(NumericType::mm())),
        ...
        let ty5 = RuntimeType::Object(vec![
            (
                "foo".to_owned(),
                RuntimeType::Primitive(PrimitiveType::Number(NumericType::mm())),
            ),
        ...
        let ty6 = RuntimeType::Object(vec![
