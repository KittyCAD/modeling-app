...
impl KclValue {
    ...
    pub(crate) fn as_usize(&self) -> Option<usize> {
        match self {
            ...
            KclValue::HomArray { value, .. } | KclValue::Tuple { value, .. } if value.len() == 1 => value[0].as_usize(),
            _ => None,
        }
    }
    ...
    pub fn as_int(&self) -> Option<i64> {
        match self {
            ...
            KclValue::HomArray { value, .. } | KclValue::Tuple { value, .. } if value.len() == 1 => value[0].as_int(),
            _ => None,
        }
    }
    ...
    pub fn as_int_with_ty(&self) -> Option<(i64, NumericType)> {
        match self {
            ...
            KclValue::HomArray { value, .. } | KclValue::Tuple { value, .. } if value.len() == 1 => {
                value[0].as_int_with_ty()
            }
            _ => None,
        }
    }
    ...
    pub fn as_str(&self) -> Option<&str> {
        match self {
            ...
            KclValue::HomArray { value, .. } | KclValue::Tuple { value, .. } if value.len() == 1 => value[0].as_str(),
            _ => None,
        }
    }
