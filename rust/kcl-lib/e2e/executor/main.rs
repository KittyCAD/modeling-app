...
"#;
    ...
    assert_eq!(err, "This function expected the input argument to be of type [Solid; 1+] but it's actually of type Sketch. You can convert a sketch (2D) into a Solid (3D) by calling a function like `extrude` or `revolve`");
}
