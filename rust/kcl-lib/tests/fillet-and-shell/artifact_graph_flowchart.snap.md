...
flowchart LR
  ...
  subgraph path27 [Path]
    27["Path<br>[1364, 1389, 0]"]
  end
  subgraph path28 [Path]
    28["Path<br>[1397, 1434, 0]"]
    29["Segment<br>[1397, 1434, 0]"]
    30[Solid2d]
  end
  subgraph path31 [Path]
    31["Path<br>[1447, 1485, 0]"]
    32["Segment<br>[1447, 1485, 0]"]
    33[Solid2d]
  end
  subgraph path39 [Path]
    39["Path<br>[1364, 1389, 0]"]
  end
  subgraph path40 [Path]
    40["Path<br>[1397, 1434, 0]"]
    41["Segment<br>[1397, 1434, 0]"]
    42[Solid2d]
  end
  subgraph path43 [Path]
    43["Path<br>[1447, 1485, 0]"]
    44["Segment<br>[1447, 1485, 0]"]
    45[Solid2d]
  end
  subgraph path51 [Path]
    51["Path<br>[1364, 1389, 0]"]
  end
  subgraph path52 [Path]
    52["Path<br>[1397, 1434, 0]"]
    53["Segment<br>[1397, 1434, 0]"]
    54[Solid2d]
  end
  subgraph path55 [Path]
    55["Path<br>[1447, 1485, 0]"]
    56["Segment<br>[1447, 1485, 0]"]
    57[Solid2d]
  end
  ...
  26["Plane<br>[1337, 1356, 0]"]
  34["Sweep Extrusion<br>[1497, 1521, 0]"]
  35[Wall]
  36["Cap Start"]
  37["Cap End"]
  38["Plane<br>[1337, 1356, 0]"]
  46["Sweep Extrusion<br>[1497, 1521, 0]"]
  47[Wall]
  48["Cap Start"]
  49["Cap End"]
  50["Plane<br>[1337, 1356, 0]"]
  58["Sweep Extrusion<br>[1497, 1521, 0]"]
  59[Wall]
  60["Cap Start"]
  61["Cap End"]
  ...
  72["Cap Start"]
  73["Cap End"]
  74["EdgeCut Fillet<br>[1091, 1297, 0]"]
  75["EdgeCut Fillet<br>[1091, 1297, 0]"]
