...
flowchart LR
  ...
  15[Wall]
    %% face_code_ref=Missing NodePath
  16["Sweep Extrusion<br>[688, 764, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 6 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  17["SketchBlock<br>[98, 448, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  18["SketchBlockConstraint Horizontal<br>[205, 241, 0]"]
  ...
  19["SketchBlockConstraint Vertical<br>[329, 363, 0]"]
