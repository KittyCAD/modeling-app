...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[0, 29, 0]<br>Consumed: true"]
  ...
  1["Plane<br>[0, 29, 0]"]
    %% [ProgramBodyItem { index: 0 }]
  5["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  6[Wall]
  ...
  11["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  12["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  13["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  14["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  15["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  16["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  17["Plane<br>[29, 46, 1]"]
  ...
  30["Sweep Extrusion<br>[200, 219, 1]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 0 }, ReturnStatementArg, PipeBodyItem { index: 3 }]
  31["Sweep Extrusion<br>[200, 219, 1]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 0 }, ReturnStatementArg, PipeBodyItem { index: 3 }]
