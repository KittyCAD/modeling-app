...
flowchart LR
  ...
  15[Wall]
    %% face_code_ref=Missing NodePath
  16["Sweep Extrusion<br>[703, 786, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 6 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  17["SketchBlock<br>[113, 463, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  18["SketchBlockConstraint Horizontal<br>[220, 256, 0]"]
  ...
  19["SketchBlockConstraint Vertical<br>[344, 378, 0]"]
