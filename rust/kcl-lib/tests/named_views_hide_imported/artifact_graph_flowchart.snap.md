...
flowchart LR
  subgraph path3 [Path]
    3["Path<br>[328, 779, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    4["Segment<br>[356, 412, 0]"]
  ...
  subgraph path8 [Path]
    8["Path Region<br>[802, 852, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit, CallKwUnlabeledArg]
    9["Segment<br>[802, 852, 0]"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit, CallKwUnlabeledArg]
    10["Segment<br>[802, 852, 0]"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit, CallKwUnlabeledArg]
    11["Segment<br>[802, 852, 0]"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit, CallKwUnlabeledArg]
    12["Segment<br>[802, 852, 0]"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit, CallKwUnlabeledArg]
  end
  1["ImportedGeometry<br>[269, 305, 0]"]
    %% [ProgramBodyItem { index: 0 }]
  2["Plane<br>[328, 779, 0]"]
    %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  13["Sweep Extrusion<br>[794, 867, 0]<br>Consumed: false"]
  ...
  28["SketchBlock<br>[328, 779, 0]"]
    %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  29["SketchBlockConstraint Coincident<br>[624, 660, 0]"]
  ...
  30["SketchBlockConstraint Coincident<br>[663, 699, 0]"]
  ...
  31["SketchBlockConstraint Coincident<br>[702, 738, 0]"]
  ...
  32["SketchBlockConstraint Coincident<br>[741, 777, 0]"]
  ...
  33["NamedView "Anchor only"<br>Baseline: Show<br>[896, 1040, 0]"]
