...
flowchart LR
  ...
  1["Plane<br>[0, 29, 0]"]
    %% [ProgramBodyItem { index: 0 }]
  8["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  9[Wall]
  ...
  23["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  24["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  25["Sweep Extrusion<br>[0, 29, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }]
  26["Plane<br>[38, 55, 1]"]
