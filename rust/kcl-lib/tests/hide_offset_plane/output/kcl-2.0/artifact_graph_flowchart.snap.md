...
flowchart LR
  ...
  18["Cap End"]
    %% face_code_ref=Missing NodePath
  19["Plane<br>[1383, 1412, 0]"]
    %% [ProgramBodyItem { index: 4 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  20["Sweep Extrusion<br>[1413, 1452, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 5 }, ExpressionStatementExpr]
  21["SketchBlock<br>[65, 1231, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  22["SketchBlockConstraint Coincident<br>[427, 463, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 5 }, ExpressionStatementExpr]
  23["SketchBlockConstraint Coincident<br>[466, 502, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 6 }, ExpressionStatementExpr]
  24["SketchBlockConstraint Coincident<br>[505, 541, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 7 }, ExpressionStatementExpr]
  25["SketchBlockConstraint Coincident<br>[544, 580, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 8 }, ExpressionStatementExpr]
  26["SketchBlockConstraint Parallel<br>[583, 607, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 9 }, ExpressionStatementExpr]
  27["SketchBlockConstraint Parallel<br>[610, 634, 0]"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, SketchBlockBody, SketchBlockBodyItem { index: 10 }, ExpressionStatementExpr]
  28["SketchBlockConstraint Perpendicular<br>[637, 666, 0]"]
  ...
  29["SketchBlockConstraint Horizontal<br>[669, 686, 0]"]
  ...
  30["SketchBlockConstraint Coincident<br>[881, 919, 0]"]
  ...
  31["SketchBlockConstraint Coincident<br>[922, 956, 0]"]
  ...
  32["SketchBlockConstraint Coincident<br>[959, 995, 0]"]
  ...
  33["SketchBlockConstraint Coincident<br>[998, 1034, 0]"]
  ...
  34["SketchBlockConstraint Coincident<br>[1037, 1064, 0]"]
  ...
  35["SketchBlockConstraint Coincident<br>[1067, 1094, 0]"]
  ...
  36["SketchBlockConstraint LinesEqualLength<br>[1097, 1124, 0]"]
  ...
  37["SketchBlockConstraint Coincident<br>[1127, 1155, 0]"]
  ...
  38["SketchBlockConstraint Distance<br>[1158, 1199, 0]"]
  ...
  39["SketchBlockConstraint LinesEqualLength<br>[1202, 1229, 0]"]
