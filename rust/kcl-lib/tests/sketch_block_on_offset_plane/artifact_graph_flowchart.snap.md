...
flowchart LR
  subgraph path1 [Path]
    1["Path<br>[40, 627, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 1 }, ExpressionStatementExpr]
    6["Segment<br>[84, 136, 0]"]
