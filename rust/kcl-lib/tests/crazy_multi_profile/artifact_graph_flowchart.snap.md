...
flowchart LR
  ...
  subgraph path51 [Path]
    51["Path<br>[1936, 2000, 0]"]
    52["Segment<br>[1936, 2000, 0]"]
    53[Solid2d]
  end
  subgraph path54 [Path]
    54["Path<br>[2014, 2054, 0]"]
    55["Segment<br>[2060, 2107, 0]"]
    56["Segment<br>[2113, 2190, 0]"]
    57["Segment<br>[2196, 2293, 0]"]
    58["Segment<br>[2299, 2355, 0]"]
    59["Segment<br>[2361, 2368, 0]"]
    60[Solid2d]
  end
  1["Plane<br>[12, 31, 0]"]
  ...
  61["Sweep Extrusion<br>[2382, 2415, 0]"]
  62[Wall]
  63[Wall]
  64[Wall]
  65[Wall]
  ...
  76["Sweep RevolveAboutEdge<br>[2429, 2478, 0]"]
  77[Wall]
  78["Cap Start"]
  79["Cap End"]
