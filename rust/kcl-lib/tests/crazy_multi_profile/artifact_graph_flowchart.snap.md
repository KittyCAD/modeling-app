...
flowchart LR
  ...
  subgraph path55 [Path]
    55["Path<br>[1572, 1614, 0]<br>Consumed: true"]
  ...
  subgraph path61 [Path]
    61["Path<br>[1764, 1806, 0]<br>Consumed: false"]
  ...
  subgraph path67 [Path]
    67["Path<br>[1955, 2011, 0]<br>Consumed: false"]
  ...
  subgraph path70 [Path]
    70["Path<br>[2025, 2068, 0]<br>Consumed: true"]
  ...
  13["Cap End"]
    %% face_code_ref=Missing NodePath
  39["Sweep RevolveAboutEdge<br>[1300, 1366, 0]<br>Consumed: false"]
  ...
  44["Cap End"]
    %% face_code_ref=Missing NodePath
  45["Sweep Extrusion<br>[1380, 1411, 0]<br>Consumed: false"]
  ...
  77["Sweep Extrusion<br>[2396, 2429, 0]<br>Consumed: false"]
  ...
  83["Cap End"]
    %% face_code_ref=Missing NodePath
  84["Sweep RevolveAboutEdge<br>[2443, 2488, 0]<br>Consumed: false"]
  ...
  89["Cap End"]
    %% face_code_ref=Missing NodePath
  90["StartSketchOnFace<br>[309, 348, 0]"]
