...
flowchart LR
  ...
  subgraph path59 [Path]
    59["Path<br>[1443, 1481, 0]"]
    60["Segment<br>[1487, 1511, 0]"]
    61["Segment<br>[1517, 1542, 0]"]
  end
  subgraph path62 [Path]
    62["Path<br>[1556, 1595, 0]"]
    63["Segment<br>[1601, 1625, 0]"]
    64["Segment<br>[1631, 1656, 0]"]
    65["Segment<br>[1662, 1718, 0]"]
    66["Segment<br>[1724, 1731, 0]"]
    67[Solid2d]
  end
  subgraph path68 [Path]
    68["Path<br>[1745, 1784, 0]"]
    69["Segment<br>[1790, 1813, 0]"]
    70["Segment<br>[1819, 1844, 0]"]
    71["Segment<br>[1850, 1906, 0]"]
    72["Segment<br>[1912, 1919, 0]"]
    73[Solid2d]
  end
  subgraph path74 [Path]
    74["Path<br>[1933, 1989, 0]"]
    75["Segment<br>[1933, 1989, 0]"]
    76[Solid2d]
  end
  subgraph path77 [Path]
    77["Path<br>[2003, 2043, 0]"]
    78["Segment<br>[2049, 2096, 0]"]
    79["Segment<br>[2102, 2179, 0]"]
    80["Segment<br>[2185, 2282, 0]"]
    81["Segment<br>[2288, 2344, 0]"]
    82["Segment<br>[2350, 2357, 0]"]
    83[Solid2d]
  end
  1["Plane<br>[12, 31, 0]"]
  ...
  45["Sweep RevolveAboutEdge<br>[1280, 1351, 0]"]
  ...
  58["Plane<br>[1409, 1429, 0]"]
  84["Sweep Extrusion<br>[2371, 2404, 0]"]
  85[Wall]
  86[Wall]
  87[Wall]
  88[Wall]
  ...
  99["Sweep RevolveAboutEdge<br>[2418, 2463, 0]"]
  100[Wall]
  101[Wall]
  102[Wall]
  103["Cap Start"]
