...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[347, 372, 0]<br>Consumed: true"]
  ...
  subgraph path24 [Path]
    24["Path<br>[529, 555, 0]<br>Consumed: true"]
    ...
    26["Segment<br>[590, 609, 0]"]
      %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 3 }]
    27["Segment<br>[617, 637, 0]"]
      %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 4 }]
    28["Segment<br>[645, 652, 0]"]
      %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 5 }]
    29[Solid2d]
  end
  subgraph path46 [Path]
    46["Path<br>[763, 800, 0]<br>Consumed: true"]
  ...
  8["Sweep Extrusion<br>[474, 493, 0]<br>Consumed: false"]
  ...
  30["Sweep Extrusion<br>[660, 680, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 0 }, VariableDeclarationDeclaration, VariableDeclarationInit, FunctionExpressionBody, FunctionExpressionBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 6 }]
  31[Wall]
    %% face_code_ref=Missing NodePath
  32[Wall]
    %% face_code_ref=Missing NodePath
  ...
  49["Sweep Extrusion<br>[808, 827, 0]<br>Consumed: false"]
