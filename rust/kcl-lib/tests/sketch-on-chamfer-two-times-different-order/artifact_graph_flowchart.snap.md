...
flowchart LR
  ...
  subgraph path32 [Path]
    32["Path<br>[1156, 1191, 0]"]
    33["Segment<br>[1197, 1245, 0]"]
    34["Segment<br>[1251, 1353, 0]"]
    35["Segment<br>[1359, 1479, 0]"]
    36["Segment<br>[1485, 1541, 0]"]
    37["Segment<br>[1547, 1555, 0]"]
    38[Solid2d]
  end
  1["Plane<br>[12, 31, 0]"]
  ...
  39["Sweep Extrusion<br>[1569, 1600, 0]"]
  40[Wall]
  41[Wall]
  42[Wall]
  43[Wall]
  ...
  53["StartSketchOnFace<br>[670, 702, 0]"]
  54["StartSketchOnFace<br>[1118, 1150, 0]"]
  1 --- 2
  2 --- 3
  2 --- 4
  2 --- 5
