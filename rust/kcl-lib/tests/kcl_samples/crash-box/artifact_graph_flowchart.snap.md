...
flowchart LR
  ...
  24["EdgeCut Fillet<br>[1662, 1920, 0]"]
    %% [ProgramBodyItem { index: 9 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  25["Plane<br>[2226, 2244, 0]"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  33["Sweep Extrusion<br>[2745, 2856, 0]"]
  ...
  48["EdgeCut Fillet<br>[2922, 3070, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  49["CompositeSolid Subtract<br>[3234, 3276, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  56["Sweep Extrusion<br>[3937, 4007, 0]"]
  ...
  62["Sweep Extrusion<br>[3937, 4007, 0]"]
    %% [ProgramBodyItem { index: 19 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  63[Wall]
    %% face_code_ref=Missing NodePath
  64["Cap Start"]
  ...
  68["CompositeSolid Subtract<br>[4076, 4125, 0]"]
    %% [ProgramBodyItem { index: 20 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  69["StartSketchOnFace<br>[3503, 3550, 0]"]
