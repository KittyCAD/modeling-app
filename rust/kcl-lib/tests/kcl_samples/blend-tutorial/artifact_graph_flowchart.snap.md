...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[200, 546, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    3["Segment<br>[228, 295, 0]"]
  ...
  subgraph path5 [Path]
    5["Path<br>[559, 865, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    6["Segment<br>[587, 652, 0]"]
  ...
  subgraph path7 [Path]
    7["Path<br>[879, 938, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    8["Segment<br>[879, 938, 0]"]
      %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path14 [Path]
    14["Path<br>[952, 1011, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 4 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    15["Segment<br>[952, 1011, 0]"]
      %% [ProgramBodyItem { index: 4 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path23 [Path]
    23["Path<br>[1271, 1573, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 8 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    24["Segment<br>[1299, 1367, 0]"]
  ...
  subgraph path25 [Path]
    25["Path<br>[1587, 1674, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 9 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    26["Segment<br>[1587, 1674, 0]"]
      %% [ProgramBodyItem { index: 9 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  1["Plane<br>[200, 546, 0]"]
    %% [ProgramBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  4["Plane<br>[559, 865, 0]"]
    %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  9["Sweep Extrusion<br>[879, 938, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 3 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  10[Wall]
  ...
  16["Sweep Extrusion<br>[952, 1011, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 4 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  17[Wall]
    %% face_code_ref=Missing NodePath
  ...
  21["Sweep Blend<br>[1096, 1239, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 7 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  22["Plane<br>[1271, 1573, 0]"]
    %% [ProgramBodyItem { index: 8 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  27["Sweep Extrusion<br>[1587, 1674, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 9 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  28[Wall]
    %% face_code_ref=Missing NodePath
  ...
  32["CompositeSolid Split<br>[1753, 1806, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  33["CompositeSolid Split<br>[1753, 1806, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  34["SketchBlock<br>[200, 546, 0]"]
    %% [ProgramBodyItem { index: 1 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  35["SketchBlockConstraint HorizontalDistance<br>[298, 344, 0]"]
  ...
  36["SketchBlockConstraint HorizontalDistance<br>[347, 436, 0]"]
  ...
  37["SketchBlockConstraint VerticalDistance<br>[439, 489, 0]"]
  ...
  38["SketchBlockConstraint VerticalDistance<br>[492, 544, 0]"]
  ...
  39["SketchBlock<br>[559, 865, 0]"]
    %% [ProgramBodyItem { index: 2 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  40["SketchBlockConstraint HorizontalDistance<br>[655, 701, 0]"]
  ...
  41["SketchBlockConstraint HorizontalDistance<br>[704, 755, 0]"]
  ...
  42["SketchBlockConstraint VerticalDistance<br>[758, 808, 0]"]
  ...
  43["SketchBlockConstraint VerticalDistance<br>[811, 863, 0]"]
  ...
  44["SketchBlock<br>[1271, 1573, 0]"]
    %% [ProgramBodyItem { index: 8 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  45["SketchBlockConstraint VerticalDistance<br>[1370, 1418, 0]"]
  ...
  46["SketchBlockConstraint HorizontalDistance<br>[1421, 1471, 0]"]
  ...
  47["SketchBlockConstraint HorizontalDistance<br>[1474, 1522, 0]"]
  ...
  48["SketchBlockConstraint VerticalDistance<br>[1525, 1571, 0]"]
