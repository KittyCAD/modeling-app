...
flowchart LR
  ...
  82["Sweep Extrusion<br>[3762, 3879, 0]"]
  ...
  109["EdgeCut Chamfer<br>[3885, 4163, 0]"]
    %% [ProgramBodyItem { index: 24 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  110["EdgeCut Chamfer<br>[3885, 4163, 0]"]
    %% [ProgramBodyItem { index: 24 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  111["EdgeCut Chamfer<br>[3885, 4163, 0]"]
    %% [ProgramBodyItem { index: 24 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  112["EdgeCut Chamfer<br>[3885, 4163, 0]"]
    %% [ProgramBodyItem { index: 24 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  116["Sweep Extrusion<br>[4368, 4403, 0]"]
    %% [ProgramBodyItem { index: 27 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  117[Wall]
    %% face_code_ref=Missing NodePath
  118["SweepEdge Opposite"]
  119["SweepEdge Adjacent"]
  123["Sweep Extrusion<br>[4615, 4650, 0]"]
  ...
  129["StartSketchOnFace<br>[4226, 4266, 0]"]
    %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  130["StartSketchOnFace<br>[4469, 4509, 0]"]
