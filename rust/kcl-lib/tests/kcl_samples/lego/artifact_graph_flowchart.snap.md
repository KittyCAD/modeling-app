...
flowchart LR
  ...
  subgraph path27 [Path]
    27["Path<br>[1733, 2217, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 21 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    28["Segment<br>[1785, 1856, 0]"]
  ...
  subgraph path32 [Path]
    32["Path Region<br>[2230, 2283, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    33["Segment<br>[2230, 2283, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    34["Segment<br>[2230, 2283, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    35["Segment<br>[2230, 2283, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    36["Segment<br>[2230, 2283, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path51 [Path]
    51["Path<br>[2459, 2979, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 26 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    52["Segment<br>[2503, 2572, 0]"]
  ...
  subgraph path53 [Path]
    53["Path Region<br>[2992, 3036, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 27 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    54["Segment<br>[2992, 3036, 0]"]
      %% [ProgramBodyItem { index: 27 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path64 [Path]
    64["Path<br>[3420, 3962, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 32 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    65["Segment<br>[3466, 3533, 0]"]
  ...
  37["Sweep Extrusion<br>[2299, 2341, 0]<br>Consumed: false"]
  ...
  55["Sweep Extrusion<br>[3047, 3100, 0]<br>Consumed: false"]
  ...
  61["Pattern Transform<br>[3134, 3225, 0]<br>Copies: 1<br>Faces: 3<br>Edges: 3"]
    %% [ProgramBodyItem { index: 30 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  62["Pattern Transform<br>[3231, 3302, 0]<br>Copies: 2<br>Faces: 6<br>Edges: 6"]
    %% [ProgramBodyItem { index: 30 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  63["Pattern Transform<br>[3231, 3302, 0]<br>Copies: 2<br>Faces: 6<br>Edges: 6"]
    %% [ProgramBodyItem { index: 30 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  68["Sweep Extrusion<br>[4034, 4088, 0]<br>Consumed: false"]
  ...
  74["Pattern Transform<br>[4124, 4220, 0]<br>Copies: 0<br>Faces: 0<br>Edges: 0"]
    %% [ProgramBodyItem { index: 36 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  75["Pattern Transform<br>[4226, 4301, 0]<br>Copies: 1<br>Faces: 3<br>Edges: 3"]
  ...
  80["SketchBlock<br>[1733, 2217, 0]"]
    %% [ProgramBodyItem { index: 21 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  81["SketchBlockConstraint Coincident<br>[1939, 1975, 0]"]
  ...
  82["SketchBlockConstraint Coincident<br>[2058, 2094, 0]"]
  ...
  83["SketchBlockConstraint Coincident<br>[2179, 2215, 0]"]
  ...
  84["SketchBlock<br>[2459, 2979, 0]"]
    %% [ProgramBodyItem { index: 26 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  85["SketchBlockConstraint Coincident<br>[2676, 2728, 0]"]
  ...
  86["SketchBlockConstraint Coincident<br>[2731, 2771, 0]"]
  ...
  87["SketchBlockConstraint Radius<br>[2774, 2807, 0]"]
  ...
  88["SketchBlockConstraint HorizontalDistance<br>[2810, 2893, 0]"]
  ...
  89["SketchBlockConstraint VerticalDistance<br>[2896, 2977, 0]"]
  ...
  90["SketchBlock<br>[3420, 3962, 0]"]
    %% [ProgramBodyItem { index: 32 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  91["SketchBlockConstraint Coincident<br>[3637, 3703, 0]"]
  ...
  92["SketchBlockConstraint Coincident<br>[3706, 3747, 0]"]
  ...
  93["SketchBlockConstraint Radius<br>[3750, 3784, 0]"]
  ...
  94["SketchBlockConstraint HorizontalDistance<br>[3787, 3873, 0]"]
  ...
  95["SketchBlockConstraint VerticalDistance<br>[3876, 3960, 0]"]
