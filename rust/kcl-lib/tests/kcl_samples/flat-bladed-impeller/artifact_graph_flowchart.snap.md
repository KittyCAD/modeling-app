...
flowchart LR
  ...
  36["Sweep Extrusion<br>[1771, 1809, 0]"]
  ...
  44["Sweep Extrusion<br>[1964, 2022, 0]"]
    %% [ProgramBodyItem { index: 24 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  45[Wall]
    %% face_code_ref=Missing NodePath
  46["SweepEdge Opposite"]
  47["SweepEdge Adjacent"]
  48["StartSketchOnPlane<br>[950, 1007, 0]"]
    %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  49["StartSketchOnPlane<br>[1444, 1503, 0]"]
    %% [ProgramBodyItem { index: 16 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  50["StartSketchOnFace<br>[1648, 1684, 0]"]
    %% [ProgramBodyItem { index: 19 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  51["StartSketchOnFace<br>[1839, 1877, 0]"]
