...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[1326, 1395, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    3["Segment<br>[1326, 1395, 0]"]
      %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    4[Solid2d]
  end
  subgraph path5 [Path]
    5["Path<br>[1428, 1482, 0]<br>Consumed: true"]
  ...
  12["Cap End"]
    %% face_code_ref=Missing NodePath
  13["Plane<br>[2369, 2405, 0]"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  21["Sweep Extrusion<br>[2783, 2826, 0]<br>Consumed: true"]
  ...
  27["Cap End"]
    %% face_code_ref=Missing NodePath
  28["CompositeSolid Subtract<br>[3274, 3322, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  29["StartSketchOnPlane<br>[2420, 2445, 0]"]
