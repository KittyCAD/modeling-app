...
flowchart LR
  ...
  200["Sweep Extrusion<br>[5087, 5119, 0]"]
  ...
  208["Sweep Extrusion<br>[5409, 5444, 0]"]
  ...
  213["Sweep Extrusion<br>[5409, 5444, 0]"]
    %% [ProgramBodyItem { index: 46 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  ...
  244["Sweep Extrusion<br>[6769, 6816, 0]"]
  ...
  257["Sweep Extrusion<br>[6769, 6816, 0]"]
    %% [ProgramBodyItem { index: 55 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  258["Sweep Extrusion<br>[6769, 6816, 0]"]
    %% [ProgramBodyItem { index: 55 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  259["Sweep Extrusion<br>[6769, 6816, 0]"]
    %% [ProgramBodyItem { index: 55 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  260["Sweep Extrusion<br>[6769, 6816, 0]"]
    %% [ProgramBodyItem { index: 55 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  261["Sweep Extrusion<br>[6769, 6816, 0]"]
    %% [ProgramBodyItem { index: 55 }, VariableDeclarationDeclaration, VariableDeclarationInit]
