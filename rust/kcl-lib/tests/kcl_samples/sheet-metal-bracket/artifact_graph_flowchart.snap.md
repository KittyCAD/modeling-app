...
flowchart LR
  ...
  106["Sweep Extrusion<br>[3506, 3534, 0]"]
    %% [ProgramBodyItem { index: 16 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 3 }]
  110["Sweep Extrusion<br>[4080, 4108, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 4 }]
  111[Wall]
    %% face_code_ref=Missing NodePath
  112["SweepEdge Opposite"]
  113["SweepEdge Adjacent"]
  114["Sweep Extrusion<br>[4080, 4108, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 4 }]
  115["Sweep Extrusion<br>[4080, 4108, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 4 }]
  116["Sweep Extrusion<br>[4080, 4108, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 4 }]
  120["Sweep Extrusion<br>[4311, 4339, 0]"]
