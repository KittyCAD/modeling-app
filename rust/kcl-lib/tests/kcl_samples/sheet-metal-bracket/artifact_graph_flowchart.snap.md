...
flowchart LR
  ...
  subgraph path94 [Path]
    94["Path<br>[3136, 3225, 0]"]
    95["Segment<br>[3136, 3225, 0]"]
    96[Solid2d]
  end
  subgraph path102 [Path]
    102["Path<br>[3507, 3595, 0]"]
    103["Segment<br>[3507, 3595, 0]"]
    104[Solid2d]
  end
  subgraph path110 [Path]
    110["Path<br>[3884, 4064, 0]"]
    111["Segment<br>[3884, 4064, 0]"]
    112[Solid2d]
  end
  subgraph path120 [Path]
    120["Path<br>[4487, 4543, 0]"]
    121["Segment<br>[4487, 4543, 0]"]
    122[Solid2d]
  end
  ...
  97["Sweep Extrusion<br>[3354, 3382, 0]"]
  98[Wall]
  99["SweepEdge Opposite"]
  100["SweepEdge Adjacent"]
  101["Sweep Extrusion<br>[3354, 3382, 0]"]
  105["Sweep Extrusion<br>[3724, 3752, 0]"]
  106[Wall]
  107["SweepEdge Opposite"]
  108["SweepEdge Adjacent"]
  109["Sweep Extrusion<br>[3724, 3752, 0]"]
  113["Sweep Extrusion<br>[4318, 4346, 0]"]
  114[Wall]
  115["SweepEdge Opposite"]
  116["SweepEdge Adjacent"]
  117["Sweep Extrusion<br>[4318, 4346, 0]"]
  118["Sweep Extrusion<br>[4318, 4346, 0]"]
  119["Sweep Extrusion<br>[4318, 4346, 0]"]
  123["Sweep Extrusion<br>[4549, 4577, 0]"]
  124[Wall]
  125["SweepEdge Opposite"]
  126["SweepEdge Adjacent"]
  127["StartSketchOnFace<br>[3087, 3130, 0]"]
  128["StartSketchOnFace<br>[3458, 3501, 0]"]
  129["StartSketchOnFace<br>[3835, 3878, 0]"]
  130["StartSketchOnFace<br>[4438, 4481, 0]"]
  1 --- 2
  2 --- 3
  2 --- 4
  2 --- 5
