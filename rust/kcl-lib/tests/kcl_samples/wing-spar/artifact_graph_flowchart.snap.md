...
flowchart LR
  ...
  26["Sweep Extrusion<br>[1680, 1712, 0]"]
  ...
  70["Sweep Extrusion<br>[2943, 2970, 0]"]
  ...
  140["Sweep Extrusion<br>[3981, 4008, 0]"]
  ...
  202["Sweep Extrusion<br>[4784, 4805, 0]"]
  ...
  227["Sweep Extrusion<br>[4784, 4805, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
  228["Sweep Extrusion<br>[4784, 4805, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
  229["Sweep Extrusion<br>[4784, 4805, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
  241["Sweep Extrusion<br>[5456, 5477, 0]"]
  ...
  266["Sweep Extrusion<br>[5456, 5477, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
  267["Sweep Extrusion<br>[5456, 5477, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
  268["Sweep Extrusion<br>[5456, 5477, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 12 }]
