...
flowchart LR
  ...
  subgraph path49 [Path]
    49["Path<br>[2738, 2791, 0]"]
    50["Segment<br>[2797, 2856, 0]"]
    51["Segment<br>[2862, 2897, 0]"]
    52["Segment<br>[2903, 2936, 0]"]
    53["Segment<br>[2942, 3001, 0]"]
    54["Segment<br>[3007, 3043, 0]"]
    55["Segment<br>[3049, 3073, 0]"]
    56["Segment<br>[3079, 3086, 0]"]
    57[Solid2d]
  end
  subgraph path83 [Path]
    83["Path<br>[3681, 3728, 0]"]
    84["Segment<br>[3734, 3784, 0]"]
    85["Segment<br>[3790, 3856, 0]"]
    86["Segment<br>[3862, 3913, 0]"]
    87["Segment<br>[3919, 3984, 0]"]
    88["Segment<br>[3990, 4043, 0]"]
    89["Segment<br>[4049, 4116, 0]"]
    90["Segment<br>[4122, 4196, 0]"]
    91["Segment<br>[4202, 4270, 0]"]
    92["Segment<br>[4276, 4283, 0]"]
    93[Solid2d]
  end
  ...
  30["Sweep Extrusion<br>[2310, 2360, 0]"]
  31[Wall]
  32[Wall]
  33[Wall]
  34[Wall]
  ...
  48["Plane<br>[2635, 2677, 0]"]
  58["Sweep Extrusion<br>[3120, 3164, 0]"]
  59[Wall]
  60[Wall]
  61[Wall]
  62[Wall]
  ...
  82["Plane<br>[3607, 3633, 0]"]
  94["Sweep Extrusion<br>[4339, 4381, 0]"]
  95[Wall]
  96[Wall]
  97[Wall]
  98[Wall]
  ...
  128["Sweep Extrusion<br>[4616, 4666, 0]"]
  129[Wall]
  130[Wall]
  131[Wall]
  132[Wall]
  ...
  141["EdgeCut Fillet<br>[2397, 2538, 0]"]
  142["EdgeCut Fillet<br>[2397, 2538, 0]"]
  143["EdgeCut Fillet<br>[3207, 3338, 0]"]
  144["EdgeCut Fillet<br>[3207, 3338, 0]"]
  145["StartSketchOnPlane<br>[2621, 2678, 0]"]
  146["StartSketchOnFace<br>[4440, 4479, 0]"]
  1 --- 2
  1 --- 9
  1 --- 16
  1 --- 23
