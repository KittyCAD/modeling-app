...
flowchart LR
  ...
  subgraph path49 [Path]
    49["Path<br>[2771, 2824, 0]"]
    50["Segment<br>[2830, 2889, 0]"]
    51["Segment<br>[2895, 2930, 0]"]
    52["Segment<br>[2936, 2969, 0]"]
    53["Segment<br>[2975, 3034, 0]"]
    54["Segment<br>[3040, 3076, 0]"]
    55["Segment<br>[3082, 3106, 0]"]
    56["Segment<br>[3112, 3119, 0]"]
    57[Solid2d]
  end
  subgraph path83 [Path]
    83["Path<br>[3714, 3761, 0]"]
    84["Segment<br>[3767, 3817, 0]"]
    85["Segment<br>[3823, 3922, 0]"]
    86["Segment<br>[3928, 3979, 0]"]
    87["Segment<br>[3985, 4083, 0]"]
    88["Segment<br>[4089, 4142, 0]"]
    89["Segment<br>[4148, 4248, 0]"]
    90["Segment<br>[4254, 4328, 0]"]
    91["Segment<br>[4334, 4435, 0]"]
    92["Segment<br>[4441, 4448, 0]"]
    93[Solid2d]
  end
  ...
  30["Sweep Extrusion<br>[2343, 2393, 0]"]
  31[Wall]
  32[Wall]
  33[Wall]
  34[Wall]
  ...
  48["Plane<br>[2668, 2710, 0]"]
  58["Sweep Extrusion<br>[3153, 3197, 0]"]
  59[Wall]
  60[Wall]
  61[Wall]
  62[Wall]
  ...
  82["Plane<br>[3640, 3666, 0]"]
  94["Sweep Extrusion<br>[4504, 4546, 0]"]
  95[Wall]
  96[Wall]
  97[Wall]
  98[Wall]
  ...
  141["EdgeCut Fillet<br>[2430, 2571, 0]"]
  142["EdgeCut Fillet<br>[2430, 2571, 0]"]
  143["EdgeCut Fillet<br>[3240, 3371, 0]"]
  144["EdgeCut Fillet<br>[3240, 3371, 0]"]
  145["StartSketchOnPlane<br>[2654, 2711, 0]"]
  146["StartSketchOnFace<br>[4605, 4644, 0]"]
  1 --- 2
  1 --- 9
  1 --- 16
  1 --- 23
