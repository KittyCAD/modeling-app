...
flowchart LR
  subgraph path2 [Path]
    ...
    6["Segment<br>[1625, 1687, 0]"]
    7["Segment<br>[1693, 1700, 0]"]
    8[Solid2d]
  end
  subgraph path9 [Path]
  ...
  subgraph path49 [Path]
    49["Path<br>[2703, 2756, 0]"]
    50["Segment<br>[2762, 2821, 0]"]
    51["Segment<br>[2827, 2862, 0]"]
    52["Segment<br>[2868, 2901, 0]"]
    53["Segment<br>[2907, 2966, 0]"]
    54["Segment<br>[2972, 3008, 0]"]
    55["Segment<br>[3014, 3038, 0]"]
    56["Segment<br>[3044, 3051, 0]"]
    57[Solid2d]
  end
  subgraph path83 [Path]
    83["Path<br>[3646, 3693, 0]"]
    84["Segment<br>[3699, 3749, 0]"]
    85["Segment<br>[3755, 3821, 0]"]
    86["Segment<br>[3827, 3878, 0]"]
    87["Segment<br>[3884, 3949, 0]"]
    88["Segment<br>[3955, 4008, 0]"]
    89["Segment<br>[4014, 4081, 0]"]
    90["Segment<br>[4087, 4161, 0]"]
    91["Segment<br>[4167, 4235, 0]"]
    92["Segment<br>[4241, 4248, 0]"]
    93[Solid2d]
  end
  ...
  30["Sweep Extrusion<br>[2275, 2325, 0]"]
  31[Wall]
  32[Wall]
  33[Wall]
  34[Wall]
  ...
  48["Plane<br>[2600, 2642, 0]"]
  58["Sweep Extrusion<br>[3085, 3129, 0]"]
  59[Wall]
  60[Wall]
  61[Wall]
  62[Wall]
  ...
  82["Plane<br>[3572, 3598, 0]"]
  94["Sweep Extrusion<br>[4304, 4346, 0]"]
  95[Wall]
  96[Wall]
  97[Wall]
  98[Wall]
  ...
  128["Sweep Extrusion<br>[4581, 4631, 0]"]
  129[Wall]
  130[Wall]
  131[Wall]
  132[Wall]
  ...
  141["EdgeCut Fillet<br>[2362, 2503, 0]"]
  142["EdgeCut Fillet<br>[2362, 2503, 0]"]
  143["EdgeCut Fillet<br>[3172, 3303, 0]"]
  144["EdgeCut Fillet<br>[3172, 3303, 0]"]
  145["StartSketchOnPlane<br>[2586, 2643, 0]"]
  146["StartSketchOnFace<br>[4405, 4444, 0]"]
  1 --- 2
  1 --- 9
  1 --- 16
  1 --- 23
