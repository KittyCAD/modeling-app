...
flowchart LR
  ...
  subgraph path38 [Path]
    38["Path<br>[1830, 1892, 0]"]
    39["Segment<br>[1830, 1892, 0]"]
    40[Solid2d]
  end
  subgraph path48 [Path]
    48["Path<br>[2126, 2185, 0]"]
    49["Segment<br>[2126, 2185, 0]"]
    50[Solid2d]
  end
  ...
  41["Sweep Extrusion<br>[2031, 2068, 0]"]
  42[Wall]
  43["SweepEdge Opposite"]
  44["SweepEdge Adjacent"]
  45["Sweep Extrusion<br>[2031, 2068, 0]"]
  46["Sweep Extrusion<br>[2031, 2068, 0]"]
  47["Sweep Extrusion<br>[2031, 2068, 0]"]
  51["Sweep Extrusion<br>[2256, 2293, 0]"]
  52[Wall]
  53["SweepEdge Opposite"]
  54["SweepEdge Adjacent"]
  55["Sweep Extrusion<br>[2256, 2293, 0]"]
  56["StartSketchOnFace<br>[1786, 1824, 0]"]
  57["StartSketchOnFace<br>[2082, 2120, 0]"]
  1 --- 2
  2 --- 3
  2 --- 4
  2 --- 5
