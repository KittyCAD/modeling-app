...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[708, 1393, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    3["Segment<br>[735, 827, 0]"]
  ...
  subgraph path5 [Path]
    5["Path Region<br>[1408, 1464, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 6 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    6["Segment<br>[1408, 1464, 0]"]
      %% [ProgramBodyItem { index: 6 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    7["Segment<br>[1408, 1464, 0]"]
      %% [ProgramBodyItem { index: 6 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path18 [Path]
    18["Path<br>[1700, 2134, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 10 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    19["Segment<br>[1730, 1802, 0]"]
  ...
  subgraph path20 [Path]
    20["Path Region<br>[2247, 2285, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    21["Segment<br>[2247, 2285, 0]"]
      %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path33 [Path]
    33["Path<br>[3471, 3575, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 29 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    34["Segment<br>[3507, 3573, 0]"]
  ...
  subgraph path35 [Path]
    35["Path Region<br>[3589, 3628, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 30 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    36["Segment<br>[3589, 3628, 0]"]
      %% [ProgramBodyItem { index: 30 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path46 [Path]
    46["Path<br>[4483, 4588, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 39 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    47["Segment<br>[4520, 4586, 0]"]
  ...
  subgraph path48 [Path]
    48["Path Region<br>[4603, 4643, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 40 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    49["Segment<br>[4603, 4643, 0]"]
      %% [ProgramBodyItem { index: 40 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  1["Plane<br>[708, 1393, 0]"]
    %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  8["Sweep Extrusion<br>[1476, 1535, 0]<br>Consumed: false"]
  ...
  17["Plane<br>[1700, 2134, 0]"]
    %% [ProgramBodyItem { index: 10 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  22["Sweep Extrusion<br>[2304, 2367, 0]<br>Consumed: false"]
  ...
  28["EdgeCut Fillet<br>[2486, 2604, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  29["Pattern Transform<br>[2893, 2990, 0]<br>Copies: 1<br>Faces: 4<br>Edges: 5"]
    %% [ProgramBodyItem { index: 20 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  30["Pattern Transform<br>[2996, 3073, 0]<br>Copies: 1<br>Faces: 4<br>Edges: 5"]
    %% [ProgramBodyItem { index: 20 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  31["Pattern Transform<br>[2996, 3073, 0]<br>Copies: 1<br>Faces: 4<br>Edges: 5"]
    %% [ProgramBodyItem { index: 20 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  32["Plane<br>[3430, 3457, 0]"]
    %% [ProgramBodyItem { index: 28 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  37["Sweep Extrusion<br>[3656, 3715, 0]<br>Consumed: false"]
  ...
  56["EdgeCut Fillet<br>[4746, 4850, 0]"]
    %% [ProgramBodyItem { index: 42 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 1 }]
  57["SketchBlock<br>[708, 1393, 0]"]
    %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  58["SketchBlockConstraint Horizontal<br>[904, 921, 0]"]
  ...
  59["SketchBlockConstraint Coincident<br>[924, 961, 0]"]
  ...
  60["SketchBlockConstraint Coincident<br>[964, 997, 0]"]
  ...
  61["SketchBlockConstraint Vertical<br>[1096, 1116, 0]"]
  ...
  62["SketchBlockConstraint Coincident<br>[1119, 1162, 0]"]
  ...
  63["SketchBlockConstraint Coincident<br>[1165, 1201, 0]"]
  ...
  64["SketchBlockConstraint Coincident<br>[1204, 1241, 0]"]
  ...
  65["SketchBlockConstraint VerticalDistance<br>[1244, 1318, 0]"]
  ...
  66["SketchBlockConstraint HorizontalDistance<br>[1321, 1391, 0]"]
  ...
  67["SketchBlock<br>[1700, 2134, 0]"]
    %% [ProgramBodyItem { index: 10 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  68["SketchBlockConstraint Horizontal<br>[1906, 1928, 0]"]
  ...
  69["SketchBlockConstraint Coincident<br>[1931, 1976, 0]"]
  ...
  70["SketchBlockConstraint Coincident<br>[1979, 2023, 0]"]
  ...
  71["SketchBlockConstraint HorizontalDistance<br>[2026, 2093, 0]"]
  ...
  72["SketchBlockConstraint Coincident<br>[2096, 2132, 0]"]
  ...
  73["SketchBlock<br>[3471, 3575, 0]"]
    %% [ProgramBodyItem { index: 29 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  74["SketchBlock<br>[4483, 4588, 0]"]
    %% [ProgramBodyItem { index: 39 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  1 --- 2
  1 <--x 5
  1 <--x 57
