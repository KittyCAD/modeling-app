...
flowchart LR
  ...
  subgraph path6 [Path]
    6["Path<br>[1649, 1725, 0]"]
    18["Segment<br>[1649, 1725, 0]"]
    21[Solid2d]
  end
  subgraph path7 [Path]
    7["Path<br>[1649, 1725, 0]"]
    19["Segment<br>[1649, 1725, 0]"]
    22[Solid2d]
  end
  1["Plane<br>[700, 717, 0]"]
  2["StartSketchOnFace<br>[1605, 1641, 0]"]
  3["StartSketchOnFace<br>[1605, 1641, 0]"]
  24["Sweep Extrusion<br>[1494, 1529, 0]"]
  25["Sweep Extrusion<br>[1733, 1766, 0]"]
  26["Sweep Extrusion<br>[1733, 1766, 0]"]
  27[Wall]
  28[Wall]
  29[Wall]
  30[Wall]
  ...
  59["EdgeCut Chamfer<br>[1829, 1876, 0]"]
  60["EdgeCut Chamfer<br>[1829, 1876, 0]"]
  1 --- 4
  1 --- 5
  38 x--> 2
  38 x--> 3
