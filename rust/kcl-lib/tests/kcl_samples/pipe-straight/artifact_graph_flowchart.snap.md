...
flowchart LR
  ...
  subgraph path18 [Path]
    18["Path<br>[1292, 1711, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    19["Segment<br>[1332, 1403, 0]"]
  ...
  subgraph path21 [Path]
    21["Path Region<br>[1727, 1778, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    22["Segment<br>[1727, 1778, 0]"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    23["Segment<br>[1727, 1778, 0]"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    47["Segment<br>[2749, 2770, 0]"]
      %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    48["Segment<br>[2749, 2770, 0]"]
      %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  end
  subgraph path34 [Path]
    34["Path<br>[1895, 2310, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    35["Segment<br>[1925, 2001, 0]"]
  ...
  subgraph path36 [Path]
    36["Path Region<br>[2324, 2367, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 19 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    37["Segment<br>[2324, 2367, 0]"]
      %% [ProgramBodyItem { index: 19 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    54["Segment<br>[2749, 2770, 0]"]
      %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  end
  ...
  17["Plane<br>[1292, 1711, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  24["Sweep Extrusion<br>[1792, 1857, 0]<br>Consumed: true"]
  ...
  33["Plane<br>[1895, 2310, 0]"]
    %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  38["Sweep Extrusion<br>[2383, 2446, 0]<br>Consumed: true"]
  ...
  44["Pattern Circular<br>[2464, 2532, 0]<br>Copies: 15<br>Faces: 45<br>Edges: 45"]
    %% [ProgramBodyItem { index: 21 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  45["CompositeSolid Subtract<br>[2555, 2603, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  46["CompositeSolid Subtract<br>[2749, 2770, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  49["Sweep Extrusion<br>[2749, 2770, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  50[Wall]
    %% face_code_ref=Missing NodePath
  51[Wall]
  ...
  53["Cap End"]
    %% face_code_ref=Missing NodePath
  55["Sweep Extrusion<br>[2749, 2770, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 25 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  56[Wall]
    %% face_code_ref=Missing NodePath
  57["SketchBlock<br>[710, 1113, 0]"]
    %% [ProgramBodyItem { index: 10 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  58["SketchBlockConstraint Coincident<br>[822, 866, 0]"]
  ...
  59["SketchBlockConstraint Coincident<br>[962, 1006, 0]"]
  ...
  60["SketchBlockConstraint Radius<br>[1009, 1059, 0]"]
  ...
  61["SketchBlockConstraint Radius<br>[1062, 1111, 0]"]
  ...
  62["SketchBlock<br>[1292, 1711, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  63["SketchBlockConstraint Coincident<br>[1406, 1452, 0]"]
  ...
  64["SketchBlockConstraint Coincident<br>[1550, 1596, 0]"]
  ...
  65["SketchBlockConstraint Radius<br>[1599, 1653, 0]"]
  ...
  66["SketchBlockConstraint Radius<br>[1656, 1709, 0]"]
  ...
  67["SketchBlock<br>[1895, 2310, 0]"]
    %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  68["SketchBlockConstraint Coincident<br>[2098, 2139, 0]"]
  ...
  69["SketchBlockConstraint Coincident<br>[2142, 2173, 0]"]
  ...
  70["SketchBlockConstraint Horizontal<br>[2176, 2193, 0]"]
  ...
  71["SketchBlockConstraint Radius<br>[2196, 2235, 0]"]
  ...
  72["SketchBlockConstraint HorizontalDistance<br>[2238, 2308, 0]"]
