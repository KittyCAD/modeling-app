...
flowchart LR
  ...
  67["Sweep Extrusion<br>[2363, 2396, 0]"]
  ...
  112["Sweep Extrusion<br>[3061, 3109, 0]"]
  ...
  188["Sweep Extrusion<br>[4749, 4808, 0]"]
    %% [ProgramBodyItem { index: 36 }, ExpressionStatementExpr, PipeBodyItem { index: 0 }]
  189[Wall]
    %% face_code_ref=Missing NodePath
  190[Wall]
  ...
  203["StartSketchOnPlane<br>[1738, 1781, 0]"]
    %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  204["StartSketchOnPlane<br>[2551, 2594, 0]"]
