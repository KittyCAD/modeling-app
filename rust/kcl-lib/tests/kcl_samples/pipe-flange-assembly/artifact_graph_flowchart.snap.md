...
flowchart LR
  ...
  subgraph path15 [Path]
    15["Path<br>[1202, 1261, 7]"]
    16["Segment<br>[1202, 1261, 7]"]
    17[Solid2d]
  end
  subgraph path23 [Path]
    23["Path<br>[1368, 1428, 7]"]
    24["Segment<br>[1368, 1428, 7]"]
    25[Solid2d]
  end
  subgraph path31 [Path]
    31["Path<br>[1590, 1643, 7]"]
    32["Segment<br>[1590, 1643, 7]"]
    33[Solid2d]
  end
  ...
  subgraph path52 [Path]
    52["Path<br>[1202, 1261, 7]"]
    53["Segment<br>[1202, 1261, 7]"]
    54[Solid2d]
  end
  subgraph path60 [Path]
    60["Path<br>[1368, 1428, 7]"]
    61["Segment<br>[1368, 1428, 7]"]
    62[Solid2d]
  end
  subgraph path68 [Path]
    68["Path<br>[1590, 1643, 7]"]
    69["Segment<br>[1590, 1643, 7]"]
    70[Solid2d]
  end
  ...
  9["Sweep Extrusion<br>[1020, 1060, 7]"]
  10[Wall]
  11["Cap Start"]
  12["Cap End"]
  13["SweepEdge Opposite"]
  14["SweepEdge Adjacent"]
  18["Sweep Extrusion<br>[1269, 1306, 7]"]
  19[Wall]
  20["Cap End"]
  21["SweepEdge Opposite"]
  22["SweepEdge Adjacent"]
  26["Sweep Extrusion<br>[1436, 1474, 7]"]
  27[Wall]
  28["Cap End"]
  29["SweepEdge Opposite"]
  30["SweepEdge Adjacent"]
  34["Sweep Extrusion<br>[1651, 1693, 7]"]
  35[Wall]
  36["SweepEdge Opposite"]
  37["SweepEdge Adjacent"]
  38["Plane<br>[570, 587, 7]"]
  42["Plane<br>[892, 909, 7]"]
  46["Sweep Extrusion<br>[1020, 1060, 7]"]
  47[Wall]
  48["Cap Start"]
  49["Cap End"]
  50["SweepEdge Opposite"]
  51["SweepEdge Adjacent"]
  55["Sweep Extrusion<br>[1269, 1306, 7]"]
  56[Wall]
  57["Cap End"]
  58["SweepEdge Opposite"]
  59["SweepEdge Adjacent"]
  63["Sweep Extrusion<br>[1436, 1474, 7]"]
  64[Wall]
  65["Cap End"]
  66["SweepEdge Opposite"]
  67["SweepEdge Adjacent"]
  71["Sweep Extrusion<br>[1651, 1693, 7]"]
  72[Wall]
  ...
  228["StartSketchOnFace<br>[1155, 1194, 7]"]
  229["StartSketchOnFace<br>[1323, 1360, 7]"]
  230["StartSketchOnFace<br>[1544, 1582, 7]"]
  231["StartSketchOnFace<br>[1155, 1194, 7]"]
  232["StartSketchOnFace<br>[1323, 1360, 7]"]
  233["StartSketchOnFace<br>[1544, 1582, 7]"]
