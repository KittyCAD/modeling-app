...
flowchart LR
  ...
  subgraph path23 [Path]
    23["Path<br>[932, 984, 3]"]
    24["Segment<br>[932, 984, 3]"]
    25[Solid2d]
  end
  subgraph path32 [Path]
    32["Path<br>[1211, 1267, 3]"]
    33["Segment<br>[1211, 1267, 3]"]
    34[Solid2d]
  end
  subgraph path40 [Path]
    40["Path<br>[1371, 1428, 3]"]
    41["Segment<br>[1371, 1428, 3]"]
    42[Solid2d]
  end
  subgraph path48 [Path]
    48["Path<br>[1587, 1637, 3]"]
    49["Segment<br>[1587, 1637, 3]"]
    50[Solid2d]
  end
  ...
  subgraph path60 [Path]
    60["Path<br>[932, 984, 3]"]
    61["Segment<br>[932, 984, 3]"]
    62[Solid2d]
  end
  subgraph path69 [Path]
    69["Path<br>[1211, 1267, 3]"]
    70["Segment<br>[1211, 1267, 3]"]
    71[Solid2d]
  end
  subgraph path77 [Path]
    77["Path<br>[1371, 1428, 3]"]
    78["Segment<br>[1371, 1428, 3]"]
    79[Solid2d]
  end
  subgraph path85 [Path]
    85["Path<br>[1587, 1637, 3]"]
    86["Segment<br>[1587, 1637, 3]"]
    87[Solid2d]
  end
  ...
  22["Plane<br>[907, 924, 3]"]
  26["Sweep Extrusion<br>[1032, 1069, 3]"]
  27[Wall]
    %% face_code_ref=Missing NodePath
  28["Cap Start"]
  29["Cap End"]
  ...
  35["Sweep Extrusion<br>[1275, 1309, 3]"]
  36[Wall]
    %% face_code_ref=Missing NodePath
  37["Cap End"]
    %% face_code_ref=Missing NodePath
  ...
  43["Sweep Extrusion<br>[1436, 1471, 3]"]
  44[Wall]
    %% face_code_ref=Missing NodePath
  45["Cap End"]
  46["SweepEdge Opposite"]
  47["SweepEdge Adjacent"]
  51["Sweep Extrusion<br>[1645, 1684, 3]"]
  52[Wall]
    %% face_code_ref=Missing NodePath
  53["SweepEdge Opposite"]
  54["SweepEdge Adjacent"]
  55["Plane<br>[588, 605, 3]"]
  59["Plane<br>[907, 924, 3]"]
  63["Sweep Extrusion<br>[1032, 1069, 3]"]
  64[Wall]
    %% face_code_ref=Missing NodePath
  65["Cap Start"]
  66["Cap End"]
  ...
  72["Sweep Extrusion<br>[1275, 1309, 3]"]
  73[Wall]
    %% face_code_ref=Missing NodePath
  74["Cap End"]
    %% face_code_ref=Missing NodePath
  ...
  80["Sweep Extrusion<br>[1436, 1471, 3]"]
  81[Wall]
    %% face_code_ref=Missing NodePath
  82["Cap End"]
  83["SweepEdge Opposite"]
  84["SweepEdge Adjacent"]
  88["Sweep Extrusion<br>[1645, 1684, 3]"]
  89[Wall]
    %% face_code_ref=Missing NodePath
  ...
  228["StartSketchOnFace<br>[1164, 1203, 3]"]
  229["StartSketchOnFace<br>[1326, 1363, 3]"]
  230["StartSketchOnFace<br>[1541, 1579, 3]"]
  231["StartSketchOnFace<br>[1164, 1203, 3]"]
  232["StartSketchOnFace<br>[1326, 1363, 3]"]
  233["StartSketchOnFace<br>[1541, 1579, 3]"]
