...
flowchart LR
  ...
  19["Cap End"]
    %% face_code_ref=Missing NodePath
  20["EdgeCut Fillet<br>[1438, 1535, 0]"]
    %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  21["EdgeCut Fillet<br>[1556, 1654, 0]"]
    %% [ProgramBodyItem { index: 13 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  22["EdgeCut Fillet<br>[1693, 1946, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  23["PlaneOfFace<br>[1989, 2290, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  24["Plane<br>[1989, 2290, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  35["Sweep RevolveAboutEdge<br>[1989, 2290, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  36[Wall]
    %% face_code_ref=Missing NodePath
  37[Wall]
  ...
  39[Wall]
    %% face_code_ref=Missing NodePath
  40["CompositeSolid Subtract<br>[1989, 2290, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  41["Plane<br>[2398, 2415, 0]"]
    %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  49["Sweep Extrusion<br>[2833, 2883, 0]<br>Consumed: true"]
  ...
  55["Cap End"]
    %% face_code_ref=Missing NodePath
  56["CompositeSolid Subtract<br>[2918, 2976, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 21 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  57["StartSketchOnPlane<br>[8207, 8310, 15]"]
