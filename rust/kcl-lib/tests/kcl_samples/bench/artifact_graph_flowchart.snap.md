...
flowchart LR
  ...
  1["Plane<br>[ProgramBodyItem { index: 8 }, ExpressionStatementExpr, CallKwUnlabeledArg]"]
  2["Plane<br>[ProgramBodyItem { index: 9 }, ExpressionStatementExpr, CallKwUnlabeledArg]"]
  3["Plane<br>[ProgramBodyItem { index: 10 }, ExpressionStatementExpr, CallKwUnlabeledArg]"]
  4["Plane<br>[ProgramBodyItem { index: 11 }, ExpressionStatementExpr, CallKwUnlabeledArg]"]
  5["Plane<br>[ProgramBodyItem { index: 12 }, ExpressionStatementExpr, CallKwUnlabeledArg]"]
