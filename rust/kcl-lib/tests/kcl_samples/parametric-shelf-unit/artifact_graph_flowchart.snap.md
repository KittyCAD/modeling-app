...
flowchart LR
  ...
  14["Cap End"]
    %% face_code_ref=Missing NodePath
  15["Sweep Extrusion<br>[2163, 2209, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 19 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  22["Sweep Extrusion<br>[2473, 2514, 0]<br>Consumed: false"]
  ...
  28["Cap End"]
    %% face_code_ref=Missing NodePath
  29["Plane<br>[2563, 2600, 0]"]
    %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  36["Sweep Extrusion<br>[2852, 2903, 0]<br>Consumed: false"]
  ...
  42["Cap End"]
    %% face_code_ref=Missing NodePath
  43["StartSketchOnPlane<br>[2620, 2650, 0]"]
