...
flowchart LR
  ...
  subgraph path81 [Path]
    81["Path<br>[2884, 3050, 0]"]
    82["Segment<br>[2884, 3050, 0]"]
    83[Solid2d]
  end
  subgraph path93 [Path]
    93["Path<br>[4363, 4388, 0]"]
    94["Segment<br>[4394, 4466, 0]"]
    95["Segment<br>[4472, 4545, 0]"]
    96["Segment<br>[4551, 4604, 0]"]
    97["Segment<br>[4610, 4631, 0]"]
    98[Solid2d]
  end
  ...
  84["Sweep Extrusion<br>[3272, 3299, 0]"]
  85[Wall]
  86["Cap Start"]
  87["SweepEdge Opposite"]
  88["SweepEdge Adjacent"]
  89["Sweep Extrusion<br>[3272, 3299, 0]"]
  90["Sweep Extrusion<br>[3272, 3299, 0]"]
  91["Sweep Extrusion<br>[3272, 3299, 0]"]
  92["Plane<br>[4324, 4356, 0]"]
  99["Sweep Extrusion<br>[4637, 4681, 0]"]
  100[Wall]
  101[Wall]
  102[Wall]
  103[Wall]
  ...
  114["EdgeCut Fillet<br>[4687, 4920, 0]"]
  115["EdgeCut Fillet<br>[4687, 4920, 0]"]
  116["EdgeCut Fillet<br>[4687, 4920, 0]"]
  117["EdgeCut Fillet<br>[4687, 4920, 0]"]
  118["StartSketchOnPlane<br>[900, 920, 0]"]
  119["StartSketchOnPlane<br>[900, 920, 0]"]
  120["StartSketchOnFace<br>[2834, 2878, 0]"]
  121["StartSketchOnPlane<br>[4310, 4357, 0]"]
  1 --- 2
  2 --- 3
  2 --- 4
  2 --- 5
