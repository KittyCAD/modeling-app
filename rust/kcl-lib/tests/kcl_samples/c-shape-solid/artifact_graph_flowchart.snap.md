...
flowchart LR
  subgraph path2 [Path]
    2["Path<br>[1040, 1105, 0]"]
      %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    3["Segment<br>[1040, 1105, 0]"]
      %% [ProgramBodyItem { index: 5 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    4[Solid2d]
  end
  subgraph path5 [Path]
    5["Path<br>[1138, 1191, 0]"]
  ...
  17["Plane<br>[2065, 2104, 0]"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  25["Sweep Extrusion<br>[2402, 2445, 0]"]
  ...
  40["CompositeSolid Subtract<br>[2748, 2790, 0]"]
    %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  41["StartSketchOnPlane<br>[2119, 2144, 0]"]
