...
flowchart LR
  ...
  subgraph path5 [Path]
    ...
    6["Segment<br>[1359, 1502, 0]"]
      %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    7["Segment<br>[1359, 1502, 0]"]
      %% [ProgramBodyItem { index: 12 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  end
  subgraph path18 [Path]
    18["Path<br>[1601, 2363, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    19["Segment<br>[1641, 1713, 0]"]
  ...
  subgraph path21 [Path]
    21["Path Region<br>[2380, 2519, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    22["Segment<br>[2380, 2519, 0]"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    23["Segment<br>[2380, 2519, 0]"]
      %% [ProgramBodyItem { index: 15 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    47["Segment<br>[3884, 3905, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
    48["Segment<br>[3884, 3905, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  end
  subgraph path34 [Path]
    34["Path<br>[2601, 3459, 0]<br>Consumed: false"]
      %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    35["Segment<br>[2638, 2709, 0]"]
  ...
  subgraph path36 [Path]
    36["Path Region<br>[3478, 3589, 0]<br>Consumed: true"]
      %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    37["Segment<br>[3478, 3589, 0]"]
      %% [ProgramBodyItem { index: 18 }, VariableDeclarationDeclaration, VariableDeclarationInit]
    54["Segment<br>[3884, 3905, 0]"]
      %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  end
  1["Plane<br>[578, 1337, 0]"]
    %% [ProgramBodyItem { index: 11 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  8["Sweep Revolve<br>[1515, 1584, 0]<br>Consumed: false"]
  ...
  17["Plane<br>[1601, 2363, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  24["Sweep Extrusion<br>[2534, 2582, 0]<br>Consumed: true"]
  ...
  33["Plane<br>[2601, 3459, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  38["Sweep Extrusion<br>[3605, 3655, 0]<br>Consumed: true"]
  ...
  44["Pattern Circular<br>[3673, 3796, 0]<br>Copies: 15<br>Faces: 45<br>Edges: 45"]
    %% [ProgramBodyItem { index: 20 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  45["CompositeSolid Subtract<br>[3814, 3863, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 21 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  46["CompositeSolid Subtract<br>[3884, 3905, 0]<br>Consumed: false"]
    %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  49["Sweep Extrusion<br>[3884, 3905, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  50[Wall]
    %% face_code_ref=Missing NodePath
  51[Wall]
  ...
  53["Cap End"]
    %% face_code_ref=Missing NodePath
  55["Sweep Extrusion<br>[3884, 3905, 0]<br>Consumed: true"]
    %% [ProgramBodyItem { index: 22 }, VariableDeclarationDeclaration, VariableDeclarationInit, PipeBodyItem { index: 0 }]
  56[Wall]
    %% face_code_ref=Missing NodePath
  ...
  65["SketchBlock<br>[1601, 2363, 0]"]
    %% [ProgramBodyItem { index: 14 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  66["SketchBlockConstraint Coincident<br>[1819, 1864, 0]"]
  ...
  67["SketchBlockConstraint Coincident<br>[1867, 1940, 0]"]
  ...
  68["SketchBlockConstraint Vertical<br>[1943, 1970, 0]"]
  ...
  69["SketchBlockConstraint VerticalDistance<br>[1973, 2074, 0]"]
  ...
  70["SketchBlockConstraint Coincident<br>[2172, 2248, 0]"]
  ...
  71["SketchBlockConstraint Radius<br>[2251, 2305, 0]"]
  ...
  72["SketchBlockConstraint Radius<br>[2308, 2361, 0]"]
  ...
  73["SketchBlock<br>[2601, 3459, 0]"]
    %% [ProgramBodyItem { index: 17 }, VariableDeclarationDeclaration, VariableDeclarationInit]
  74["SketchBlockConstraint Coincident<br>[2926, 2998, 0]"]
  ...
  75["SketchBlockConstraint Coincident<br>[3001, 3048, 0]"]
  ...
  76["SketchBlockConstraint Coincident<br>[3051, 3127, 0]"]
  ...
  77["SketchBlockConstraint Horizontal<br>[3130, 3161, 0]"]
  ...
  78["SketchBlockConstraint Vertical<br>[3164, 3193, 0]"]
  ...
  79["SketchBlockConstraint HorizontalDistance<br>[3196, 3300, 0]"]
  ...
  80["SketchBlockConstraint VerticalDistance<br>[3303, 3408, 0]"]
  ...
  81["SketchBlockConstraint Radius<br>[3411, 3457, 0]"]
