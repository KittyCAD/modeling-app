...
> Gotcha: running the docker container with a mismatched image against your node_modules will cause a failure. Make sure the versions are matched and up to date.
