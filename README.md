...
The release builds can be find under the `out-{platform}` zip, at the very bottom of the `build-publish-apps` action page for each commit on this branch.
